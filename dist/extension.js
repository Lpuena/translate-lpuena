...
/* harmony export */ });
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var http_errors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(18);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(28);
...
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16);
/* harmony import */ var zlib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(17);
...
var mappingTable = __webpack_require__(15);
...
class Translator {
    ...
    async translateLoading(language, selectedText, input) {
        ...
        await vscode.window.withProgress(progressOptions, async (progress) => {
            try {
                ...
                /* eslint-disable */ console.log(...oo_oo(`f1c79830_0`, '原始数据', raw));
                let result;
                if (!input) {
    ...
    format(content) {
        ...
        /* eslint-disable */ console.log(...oo_oo(`f1c79830_1`, result));
        return result;
    }
    // input输入翻译函数
    async inputTranslation() {
        ...
        if (hasChinese) {
            ...
            /* eslint-disable */ console.log(...oo_oo(`f1c79830_2`, '翻译成英文'));
        }
        else {
            // 不包含中文,翻译到中文
            this.getContent(enum_1.Language.chinese, input);
            /* eslint-disable */ console.log(...oo_oo(`f1c79830_3`, '翻译成中文'));
        }
    }
    // 展示结果
    async showTranslationResult(result) {
        ...
        vscode.window.showInformationMessage(message, '复制').then(selection => {
            /* eslint-disable */ console.log(...oo_oo(`f1c79830_4`, 'selection', selection));
            if (selection === '复制') {
...
const vscode = __webpack_require__(1);
const Translator_1 = __webpack_require__(29);
const enum_1 = __webpack_require__(30);
