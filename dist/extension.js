...
const google_translate_api_1 = __webpack_require__(3);
const enum_1 = __webpack_require__(30);
const Api_1 = __webpack_require__(69);
// TODO:优化翻译接口，两个交替请求
class Translator {
    constructor() {
        this.apiName = 'google';
    ...
    // 获取要翻译的内容
    async getContent(language, input) {
        // 获取当前编辑器
    ...
    // 加载 翻译
    async translateLoading(language, selectedText, input) {
        // 显示加载提示
        ...
        await vscode.window.withProgress(progressOptions, async (progress) => {
            try {
                ...
                /* eslint-disable */ console.log(...oo_oo(`8250076e_0`, 'name', this.apiName));
                let translatedText;
    ...
    format(content) {
        ...
        /* eslint-disable */ console.log(...oo_oo(`8250076e_2`, result));
        return result;
    }
    // input输入翻译函数
    async inputTranslation() {
        ...
        if (hasChinese) {
            // 包含中文,翻译到英文
            this.getContent(enum_1.Language.english, input);
            /* eslint-disable */ console.log(...oo_oo(`8250076e_3`, '翻译成英文'));
        }
        else {
            // 不包含中文,翻译到中文
            this.getContent(enum_1.Language.chinese, input);
            /* eslint-disable */ console.log(...oo_oo(`8250076e_4`, '翻译成中文'));
        }
    }
    // 展示结果
    async showTranslationResult(result) {
        const message = `Translated: ${result}`;
        vscode.window.showInformationMessage(message, '复制').then(selection => {
            /* eslint-disable */ console.log(...oo_oo(`8250076e_5`, 'selection', selection));
            if (selection === '复制') {
...
/* harmony import */ var http_errors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(29);
...
class Translator {
    ...
    async translate() {
        ...
        const res = await (0,node_fetch__WEBPACK_IMPORTED_MODULE_0__["default"])(url, fetchOptions);
        if (!res.ok)
...
var toIdentifier = __webpack_require__(28)
...
var codes = __webpack_require__(24)
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.baiDuApi = void 0;
const axios_1 = __webpack_require__(32);
const md5 = __webpack_require__(65);
const vscode = __webpack_require__(1);
// 请求百度接口
const baiDuApi = async (q, to) => {
    ...
    /* eslint-disable */ console.log(...oo_oo(`a09fbea6_0`, '数据baidu', data.trans_result[0]));
...
module.exports =
{
  ...
  serial        : __webpack_require__(48),
  serialOrdered : __webpack_require__(49)
};
...
var iterate    = __webpack_require__(42)
  , initState  = __webpack_require__(46)
  , terminator = __webpack_require__(47)
  ;
...
var defer = __webpack_require__(44);
...
var abort = __webpack_require__(45)
  , async = __webpack_require__(43)
  ;
...
var serialOrdered = __webpack_require__(49);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(55)("follow-redirects");
    }
    catch (error) { /* */ }
...
try {
	...
	const supportsColor = __webpack_require__(61);
...
(function(){
  var crypt = __webpack_require__(66),
      utf8 = (__webpack_require__(67).utf8),
      isBuffer = __webpack_require__(68),
      bin = (__webpack_require__(67).bin),
...
exports.Api = void 0;
const google_translate_api_1 = __webpack_require__(3);
const baidu_1 = __webpack_require__(31);
class Api {
    // 谷歌翻译
    async googleApi(selectedText, language) {
        const translation = await (0, google_translate_api_1.translate)(selectedText, { to: language });
        const translatedText = translation.text;
        const raw = translation.raw;
        /* eslint-disable */ console.log(...oo_oo(`f419507f_0`, '原始数据', raw));
        return translatedText;
    }
    // 百度翻译
    async baiduApi(selectedText, language) {
        return (0, baidu_1.baiDuApi)(selectedText, language);
    }
}
exports.Api = Api;
/* eslint-disable */ ;
...
function activate(context) {
    ...
    /* eslint-disable */ console.log(...oo_oo(`578eecd7_0`, 1));
    let disposable = vscode.commands.registerCommand('translate.toChinese', () => {
        translator.getContent(enum_1.Language.chinese);
    });
    let toEnglish = vscode.commands.registerCommand('translate.toEnglish', () => {
        translator.getContent(enum_1.Language.english);
    });
